# Identity and Access (Azure Entra ID)
...
- **Role**
  - consists of Security Principal (i.e User, Group), Role Definition (read, write, delete,..) , Scope (Resource, Resource Group, ...)
  - Sets of permissions
...
- Also **User Administrator**, **Billing Administrator**
  <img width="397" alt="Bildschirmfoto 2024-10-09 um 15 06 35" src="https://github.com/user-attachments/assets/4b79187c-3d67-415c-8ecd-05793ab85769">
