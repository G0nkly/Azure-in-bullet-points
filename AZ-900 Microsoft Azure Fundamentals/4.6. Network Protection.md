...
- protects Azure VNets resources
- is created in its own VNet, other VNets can pass through this Central VNet
- Microsoft Threat Intelligence included
...
- supports Basic / Multi-site listeners (latter forwards request according to host header and name)
- Backend Targets (either backend-pool or redirection)
